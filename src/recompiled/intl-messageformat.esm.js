...
exports.isFormatXMLElementFn = exports.formatToParts = exports["default"] = exports.PART_TYPE = exports.MissingValueError = exports.InvalidValueTypeError = exports.InvalidValueError = exports.IntlMessageFormat = exports.FormatError = exports.ErrorCode = void 0;
...
var FormatError = /** @class */ (function (_super) {
    ...
    function class_1(msg, code, originalMessage) {
...
function formatToParts(els, locales, formatters, formats, values, currentPluralValue, originalMessage) {
    ...
    var result = [];
    for (var _b = 0, els_1 = els; _b < els_1.length; _b++) {
        var el = els_1[_b];
        ...
        if (isTagElement(el)) {
            var children = el.children, value2 = el.value;
            var formatFn = values[value2];
...
function createDefaultFormatters(cache) {
    ...
    return {
        getNumberFormat: memoize(function () {
            ...
            return new ((_b = Intl.NumberFormat).bind.apply(_b, __spreadArray([void 0], args, false)))();
        }, {
        ...
        getDateTimeFormat: memoize(function () {
            ...
            return new ((_b = Intl.DateTimeFormat).bind.apply(_b, __spreadArray([void 0], args, false)))();
        }, {
        ...
        getPluralRules: memoize(function () {
            ...
            return new ((_b = Intl.PluralRules).bind.apply(_b, __spreadArray([void 0], args, false)))();
        }, {
...
var _IntlMessageFormat = /** @class */ (function () {
    function class_2(message, locales, overrideFormats, opts) {
        var _this = this;
        if (locales === void 0) { locales = _IntlMessageFormat.defaultLocale; }
        this.formatterCache = {
            number: {},
            dateTime: {},
            pluralRules: {}
        ...
        this.formatToParts = function (values) { return formatToParts(_this.ast, _this.locales, _this.formatters, _this.formats, values, void 0, _this.message); };
    ...
    Object.defineProperty(class_2, "defaultLocale", {
        get: function () {
...
exports["default"] = lib_esnext_default;
/*! *****************************************************************************
